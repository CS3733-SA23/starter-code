...
public class NodeDAO {
    ...
    public static NodeDAO createInstance(
            String username, String password, String tableName, String schemaName, String connectionURL) throws SQLException, ClassNotFoundException {
    ...
    public Node addNode(
            Integer nodeID, Integer xCoord, Integer yCoord, String floorNum, String building)
            throws SQLException, ClassNotFoundException {
        Connection connection = createConnection();
        Statement statement = connection.createStatement();
        String sqlInsert =
                "INSERT INTO " + schemaName + "." + tableName + "(nodeID,xCoord,yCoord,floorNum,building) ";
        sqlInsert +=
                "VALUES(" + nodeID + "," + xCoord + "," + yCoord + ",\'" + floorNum + "\',\'" + building
                        + "\');";
     ...
     */
        public void modifyNodeByID (Integer nodeID, Integer xCoord, Integer yCoord, String floorNum, String building) throws
    ...
    */
        public ArrayList<Node> selectNodes (Integer nodeID, Integer xCoord, Integer yCoord, String floorNum, String
        building){
    ...
    Ex2: if building is "45 Francis", floorNum is "L2", and everything else is null
         then it will return a list of all nodes in the L2 floor of the 45 Francis building
    */
        public ArrayList<Node> selectNodes (
                Integer nodeID, Integer xCoord, Integer yCoord, String floorNum, String building){
            ArrayList<Node> aList = new ArrayList<Node>();
            for (int i = 0; i < nodes.size(); i++) {
                Boolean nodeIDCheck = nodeID == null || nodeID == nodes.get(i).getNodeID();
