...
public class BFSPathfinder implements IPathfinder {
    /**
     * * Finds the shortest path from the starting HospitalNode to the target HospitalNode using Breadth First Search
     *
     * @param from the starting HospitalNode
     * @param to the target HospitalNode
     * @return a list of coordinates representing the shortest path from the starting HospitalNode to the
     *     target HospitalNode
     */
